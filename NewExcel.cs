...
{
    public partial class NewExcel : Form
    {
      ...
      "; password = " + Properties.Settings.Default.password + ";";
        ...
        private void NewExcel_Shown(object sender, EventArgs e)
        {
            ISujeto lsujeto = lrn.lbd;
            //lsujeto.Registrar(this);

            this.Text = " Interfaz Excel/Colegio " + " " + this.ProductVersion;
        ...
        private void NewExcel_FormClosed(object sender, FormClosedEventArgs e)
        {
